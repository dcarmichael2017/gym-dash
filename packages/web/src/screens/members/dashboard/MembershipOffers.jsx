    ...
    return (
        <div className="mb-6">
            ...
            <div className="flex gap-4 overflow-x-auto pb-4 no-scrollbar snap-x">
                {tiers.map((tier) => {
                    // Decide target category based on tier type
                    const targetCategory = tier.interval === 'one_time' ? 'packs' : 'memberships';
                    ...
                    return (
                        <div
                            key={tier.id}
                            onClick={() => goToStore(targetCategory)}
